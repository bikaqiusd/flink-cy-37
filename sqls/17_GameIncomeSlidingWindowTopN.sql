...
(
  ...
  (
    select
      ...
      zid,
      sum(money) sum_money,
      hop_start(ptime,interval '10' second, interval '60' second ) win_start,
      hop_end(ptime,interval '10' second, interval '60' second ) win_end
    from
      game_events
    where
    ...
    group by
      gid,
      zid,
      hop(ptime,interval '10' second, interval '60' second)
  )
)
where rownum <=3
